...
const Deleivery = () => {
    ...
    async function patchsalebill(result) {
        ...
        console.log("ApiCall // salebill", "recno:", result.recno, 'transport date:', AppFunction.getToday().dataDate, 'transport time:', AppFunction.getTime().dataTime, "status:", "C", "transportpickup:", result.transportpickup)
