...
import { StyleSheet, Text, View, TouchableOpacity, FlatList, KeyboardAvoidingView, Pressable, StatusBar } from 'react-native'
...
const Grn_list = ({ navigation }) => {
    ...
    async function GrnCall() {
        ...
        const res = await axios.post(AppConstants.APIurl + '/filtergrn/', { "domainrecno": 508 });
        ...
        return (
            <View style={{ padding: '5%', flex: 1, }}>
                ...
                <Card style={styles.card}>
                    <Pressable onPress={() => navigation.navigate('Item_list', { item: item })}>
