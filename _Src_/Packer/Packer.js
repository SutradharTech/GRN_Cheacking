            ...
            <>
                <View style={{ flex: 1, margin: "1%", marginVertical: '3%' }}>
                    ...
                    <Card style={styles.card}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('ListItem', { billno: item.billno, domainrecno: item.domainrecno, domainuserrecno: item.domainuserrecno, ApiCall: ApiCall })} style={{ flex: 1, borderRadius: 20, }}>
